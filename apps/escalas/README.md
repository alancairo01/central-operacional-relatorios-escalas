...
Atualizações v13:
- A validação de cobertura dos horários técnicos agora aceita cobertura por Técnico, Supervisor Técnico ou Controlador de Operações.
- Se não houver técnico em determinado horário, mas houver Supervisor ou Controlador no mesmo horário, a regra será considerada atendida.
- O turno 00:00–06:00 de domingo continua não sendo obrigatório para técnicos.


Atualização v14:
- Supervisor ou Controlador com jornada maior cobre o horário técnico.
- Exemplo: 06:00–14:20 passa a validar 06:00–12:00.
